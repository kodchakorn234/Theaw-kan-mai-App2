...
import 'package:finalprojectnew/pagemain/account/tag.dart';
import 'package:finalprojectnew/pagemain/fav.dart';
import 'package:flutter/material.dart';
import 'package:get_storage/get_storage.dart';
import 'package:image_picker/image_picker.dart';

class accoutsetig2 extends StatefulWidget {
  const accoutsetig2({super.key});

  @override
  State<accoutsetig2> createState() => _accoutsetig2State();
}

class _accoutsetig2State extends State<accoutsetig2> {
  Uint8List? _image;
  File? selectedImage;
  var box = GetStorage();
  List listitem = [];
