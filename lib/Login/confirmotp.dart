...
class confirmotp extends StatefulWidget {
  const confirmotp({Key? key, required this.myauth}) : super(key: key);
  final EmailOTP myauth; //เรียกใช้ใน widget
  @override
...
class _confirmotpState extends State<confirmotp> {
  ...
  TextEditingController otp1controller =
      TextEditingController(); //รับค่าทางแป้นพิมพ์
                        ...
                        children: [
                          Container(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                if (await widget.myauth //เรียกใช้ widget
                                        .verifyOTP(otp: otpcontroller.text) ==
                                    true) {
                                  //ยืนยันตัวตน ถ้ารับค่าจากแป้นพืมพ์ถูก ให้ทำเงื่อนไขข้างล่าง
                                  //
